...
class SignIncmPage extends StatefulWidget {
  SignIncmPage({Key key}) : super(key: key);

  @override
  _SignIncmPageState createState() => _SignIncmPageState();
}

class _SignIncmPageState extends State<SignIncmPage> {
  bool vis = true;
                      ...
                      if (_a1 == 'Recruiter') {
                        ...
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text("Alert"),
                                content: Text("You are not a Recruiter"),
                              );
                            });
                      }
                    } else {
