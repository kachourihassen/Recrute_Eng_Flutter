...
class CreatSociete extends StatefulWidget {
  CreatSociete({Key key}) : super(key: key);

  @override
  _CreatSocieteState createState() => _CreatSocieteState();
}

class _CreatSocieteState extends State<CreatSociete> {
                          ...
                          onTap: () async {
                            ...
                            if (_globalkey.currentState.validate()) {
                              ...
                              var response = await networkHandler.post(
                                  "/societe/add/societe", data);
                              if (response.statusCode == 200 ||
                                  response.statusCode == 201) {
                                if (_imageFile.path != null) {
                                  var imageResponse =
                                      await networkHandler.patchImage(
                                          "/societe/add/image/societe",
                                          _imageFile.path);
  ...
  Widget dobField() {
    return Material(
        ...
        child: TextFormField(
            ...
            decoration:
                InputDecoration(hintText: 'Pick Date of create company'),
            onTap: () async {
    ...
    return Material(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: "About",
            helperText: "Write about your company",
