...
class SignUpLinkedInPage extends StatefulWidget {
  //SignUpLinkedInPage(firstName, {Key key}) : super(key: key);
  final String firstName;
  final String email;

  SignUpLinkedInPage(this.firstName, this.email);

  @override
  _SignUpLinkedInPageState createState() => _SignUpLinkedInPageState();
}

//enum SingingCharacter { candidate, company }

class _SignUpLinkedInPageState extends State<SignUpLinkedInPage> {
  bool vis = true;
  bool visc = true;
