...
class CvPage extends StatefulWidget {
  ...
  final String adress;
  CvPage(this.exp, this.form, this.comp, this.logi, this.email, this.tel,
      this.nom, this.prenom, this.age, this.post, this.interet, this.adress);
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<CvPage> with SingleTickerProviderStateMixin {
                                ...
                                child: new Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: new Text('My Curriculum Vitae',
                                          style: TextStyle(
  ...
  insertcv() async {
    ...
    var response = await networkHandler.post("/cv/addcv", data);
    if (response.statusCode == 200 || response.statusCode == 201) {
      if (_imageFile.path != null) {
        var imageResponse =
            await networkHandler.patchImage("/cv/add/imagecv", _imageFile.path);
      ...
      //       return AlertDialog(
      //         title: Text("Alert"),
      //         content: Text("You have already a cv"),
      //       );
      showDialog(
          context: context,
          builder: (BuildContext context) {
                    ...
                    children: [
                      TextField(
                        decoration: InputDecoration(
                            ...
                            hintText: 'You already have a CV'),
                      ),
                      SizedBox(
                        width: 320.0,
                        child: RaisedButton(
